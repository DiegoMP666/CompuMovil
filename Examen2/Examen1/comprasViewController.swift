...
class comprasViewController: UIViewController {
    ...
    @IBAction func aceptarPuchurrado(_ sender: UIButton){
        let alert = UIAlertController(title: "Confirmación de Compra", message: "", preferredStyle: .alert)
